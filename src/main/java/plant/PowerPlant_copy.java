...
public class PowerPlant_copy {
     ...
     * INIT
     */
    public PowerPlant_copy() {
    }

    public PowerPlant_copy(String id, String listeningAddress, String adminServer) {
        this.plantId = id;
